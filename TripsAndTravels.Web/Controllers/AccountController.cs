    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> RecoverPassword(RecoverPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                _mailHelper.SendMail(model.Email, "TripsAndTravels Password Reset", $"<h1>TripsAndTravels Password Reset</h1>" +
        ...
        public IActionResult Register()
        {
            ...
            {
                UserType = _combosHelper.GetComboRoles()
            };
        ...
        public async Task<IActionResult> Register(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    model.UserType = _combosHelper.GetComboRoles();
                    return View(model);
                }
        ...
        public async Task<IActionResult> ConfirmEmail(string userId, string token)
        {
            ...
            UserEntity user = await _userHelper.GetUserByEmailAsync(new Guid (userId));
            if (user == null)
            {
                return NotFound();
            }
